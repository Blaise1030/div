...
export function Banner({}, ...children: HtmlEscapedString[]) {
  return div(
    {
      ...
      class:
        "fixed top-0 left-0 w-full h-auto py-2 duration-300 ease-out bg-background border-b border-border sm:py-0 z-100 shadow-sm",
      "x-cloak": "",
    },
